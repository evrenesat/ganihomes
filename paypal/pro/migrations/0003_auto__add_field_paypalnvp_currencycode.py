...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PayPalNVP.currencycode'
        db.add_column('paypal_nvp', 'currencycode', self.gf('django.db.models.fields.CharField')(default='', max_length=3, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PayPalNVP.currencycode'
        db.delete_column('paypal_nvp', 'currencycode')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 16, 1, 45, 17, 85778)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 16, 1, 45, 17, 85678)'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PayPalNVP.amt'
        db.add_column('paypal_nvp', 'amt', self.gf('django.db.models.fields.CharField')(default='', max_length=10, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PayPalNVP.amt'
        db.delete_column('paypal_nvp', 'amt')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 16, 9, 48, 4, 671943)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 16, 9, 48, 4, 671834)'}),
        ...
        'pro.paypalnvp': {
            ...
            'amt': ('django.db.models.fields.CharField', [], {'max_length': '10', 'blank': 'True'}),
            ...
            'currencycode': ('django.db.models.fields.CharField', [], {'max_length': '3', 'blank': 'True'}),

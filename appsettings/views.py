...
def app_index(request, template = 'appsettings/index.html', base_template = 'admin/base_site.html'):
...
@staff_member_required
def app_settings(request, app_name=None, template = 'appsettings/settings.html', base_template = 'admin/base_site.html'):

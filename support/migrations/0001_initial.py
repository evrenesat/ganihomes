...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('support_subjectcategory', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('hidden', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('support', ['SubjectCategory'])

        # Adding model 'Ticket'
        db.create_table('support_ticket', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('creatation', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal('support', ['Ticket'])

        # Adding model 'Reply'
        db.create_table('support_reply', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('body', self.gf('django.db.models.fields.TextField')()),
            ('creatation', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ...
        db.send_create_signal('support', ['Reply'])

        # Adding model 'Inform'
        db.create_table('support_inform', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('support', ['Inform'])


    def backwards(self, orm):
        
        # Deleting model 'SubjectCategory'
        db.delete_table('support_subjectcategory')

        # Deleting model 'Ticket'
        db.delete_table('support_ticket')

        # Deleting model 'Reply'
        db.delete_table('support_reply')

        # Deleting model 'Inform'
        db.delete_table('support_inform')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Mesaj.country'
        db.delete_column('support_mesaj', 'country')


    def backwards(self, orm):
        
        # Adding field 'Mesaj.country'
        db.add_column('support_mesaj', 'country', self.gf('django.db.models.fields.SmallIntegerField')(default=0, blank=True), keep_default=False)
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 24, 12, 6, 12, 390786)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 24, 12, 6, 12, 390681)'}),

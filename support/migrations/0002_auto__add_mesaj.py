...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Mesaj'
        db.create_table('support_mesaj', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('first_name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('last_name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('country', self.gf('django.db.models.fields.SmallIntegerField')(default=0)),
        ...
        db.send_create_signal('support', ['Mesaj'])


    def backwards(self, orm):
        
        # Deleting model 'Mesaj'
        db.delete_table('support_mesaj')
    ...
    models = {
        ...
        'support.mesaj': {
            ...
            'country': ('django.db.models.fields.SmallIntegerField', [], {'default': '0'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Mesaj.last_name'
        db.delete_column('support_mesaj', 'last_name')


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Mesaj.last_name'
        raise RuntimeError("Cannot reverse this migration. 'Mesaj.last_name' and its values cannot be restored.")
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 17, 13, 0, 27, 576643)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 17, 13, 0, 27, 576327)'}),

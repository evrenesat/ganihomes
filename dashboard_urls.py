...
urlpatterns = patterns('',
        ...
        url(r'^show_requests/$', db.show_requests, name='show_requests'),
        url(r'^show_reviews/$', db.show_reviews, name='show_reviews'),
        ...
        url(r'^invite_friend/$', db.invite_friend, name='invite_friend'),
        url(r'^support_create/$', db.support_create, name='support_create'),
        url(r'^edit_description/(?P<pid>\d+)$', db.edit_description, name='edit_description'),
...
#        url(r'^list_places/(?P<type>[^/]+)/$', db.list_places, name='list_places_bytype'),
        ...
        url(r'^show_booking/(?P<id>\d+)$', db.show_booking, name='show_booking'),
        (r'^places/(?P<id>\d+)/?$', 'review_place', {}, 'review_place'),

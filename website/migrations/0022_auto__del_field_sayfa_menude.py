...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Sayfa.menude'
        db.delete_column('website_sayfa', 'menude')


    def backwards(self, orm):
        
        # Adding field 'Sayfa.menude'
        db.add_column('website_sayfa', 'menude', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

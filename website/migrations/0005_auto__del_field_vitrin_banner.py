...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Vitrin.banner'
        db.delete_column('website_vitrin', 'banner')


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Vitrin.banner'
        raise RuntimeError("Cannot reverse this migration. 'Vitrin.banner' and its values cannot be restored.")

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Vitrin.place_photo'
        db.alter_column('website_vitrin', 'place_photo_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['places.Photo'], null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Vitrin.place_photo'
        raise RuntimeError("Cannot reverse this migration. 'Vitrin.place_photo' and its values cannot be restored.")

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CategoryTranslation.lang'
        db.add_column('website_categorytranslation', 'lang', self.gf('django.db.models.fields.CharField')(default='', max_length=2, db_index=True), keep_default=False)

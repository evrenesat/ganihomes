...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Vitrin.type'
        db.add_column('website_vitrin', 'type', self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Vitrin.type'
        db.delete_column('website_vitrin', 'type')

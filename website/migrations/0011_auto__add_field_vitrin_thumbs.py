...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Vitrin.thumbs'
        db.add_column('website_vitrin', 'thumbs', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Vitrin.thumbs'
        db.delete_column('website_vitrin', 'thumbs')

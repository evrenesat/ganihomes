...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Answer.lang'
        db.add_column('website_answer', 'lang', self.gf('django.db.models.fields.CharField')(default='tr', max_length=2, db_index=True), keep_default=False)

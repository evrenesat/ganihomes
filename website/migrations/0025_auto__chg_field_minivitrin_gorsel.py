...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MiniVitrin.gorsel'
        db.alter_column('website_minivitrin', 'gorsel', self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100))


    def backwards(self, orm):
        
        # Changing field 'MiniVitrin.gorsel'
        db.alter_column('website_minivitrin', 'gorsel', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 1, 19, 27, 39, 607225)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 1, 19, 27, 39, 607119)'}),
        ...
        'website.category': {
            ...
            'active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'main_category': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['website.MainCategory']", 'null': 'True', 'blank': 'True'}),
        ...
        'website.icerik': {
            ...
            'metin': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
        ...
        'website.maincategory': {
            'Meta': {'ordering': "['timestamp']", 'object_name': 'MainCategory'},
            'active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'text': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'})
        },
        'website.maincategorytranslation': {
            'Meta': {'ordering': "['timestamp']", 'object_name': 'MainCategoryTranslation'},
            'active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['website.MainCategory']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lang': ('django.db.models.fields.CharField', [], {'max_length': '2', 'db_index': 'True'}),
            'text': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'})
        ...
        'website.minivitrin': {
            'Meta': {'ordering': "['sira']", 'object_name': 'MiniVitrin'},
            'active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'dil_kodu': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '5', 'null': 'True', 'blank': 'True'}),
            'gorsel': ('django.db.models.fields.files.ImageField', [], {'max_length': '100'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'pul': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),

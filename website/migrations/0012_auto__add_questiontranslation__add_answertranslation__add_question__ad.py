...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('website_questiontranslation', (
        ...
        db.send_create_signal('website', ['QuestionTranslation'])

        # Adding model 'AnswerTranslation'
        db.create_table('website_answertranslation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('website', ['AnswerTranslation'])
        ...
        db.create_table('website_categorytranslation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['website.Category'])),
            ('lang', self.gf('django.db.models.fields.CharField')(max_length=2, db_index=True)),
        ...
        db.send_create_signal('website', ['CategoryTranslation'])

        # Adding model 'Answer'
        db.create_table('website_answer', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('question', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['website.Question'])),
            ('lang', self.gf('django.db.models.fields.CharField')(max_length=2, db_index=True)),
            ('text', self.gf('django.db.models.fields.TextField')()),
        ...
        db.send_create_signal('website', ['Answer'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('website_questiontranslation')

        # Deleting model 'AnswerTranslation'
        db.delete_table('website_answertranslation')

        # Deleting model 'Question'
        db.delete_table('website_question')

        # Deleting model 'CategoryTranslation'
        db.delete_table('website_categorytranslation')

        # Deleting model 'Answer'
        db.delete_table('website_answer')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 5, 18, 11, 37, 984911)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 5, 18, 11, 37, 984731)'}),

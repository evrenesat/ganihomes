...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Vitrin.etkin'
        db.delete_column('website_vitrin', 'etkin')

        # Adding field 'Vitrin.active'
        db.add_column('website_vitrin', 'active', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Vitrin.etkin'
        db.add_column('website_vitrin', 'etkin', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Deleting field 'Vitrin.active'
        db.delete_column('website_vitrin', 'active')

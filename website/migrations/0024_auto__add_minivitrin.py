...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'MiniVitrin'
        db.create_table('website_minivitrin', (
        ...
        db.send_create_signal('website', ['MiniVitrin'])


    def backwards(self, orm):
        
        # Deleting model 'MiniVitrin'
        db.delete_table('website_minivitrin')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 1, 19, 12, 28, 748906)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 1, 19, 12, 28, 748795)'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Sayfa.order'
        db.add_column('website_sayfa', 'order', self.gf('django.db.models.fields.SmallIntegerField')(default=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Sayfa.order'
        db.delete_column('website_sayfa', 'order')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Vitrin.place_photo'
        db.add_column('website_vitrin', 'place_photo', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['places.Photo']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Vitrin.place_photo'
        db.delete_column('website_vitrin', 'place_photo_id')
    ...
    models = {
        ...
        'website.vitrin': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'place_photo': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['places.Photo']"}),
            'pul': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('website_maincategory', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('text', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('website', ['MainCategory'])

        # Adding model 'MainCategoryTranslation'
        db.create_table('website_maincategorytranslation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['website.MainCategory'])),
            ('lang', self.gf('django.db.models.fields.CharField')(max_length=2, db_index=True)),
            ('text', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('website', ['MainCategoryTranslation'])

        # Adding field 'Category.main_category'
        db.add_column('website_category', 'main_category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['website.MainCategory'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'MainCategory'
        db.delete_table('website_maincategory')

        # Deleting model 'MainCategoryTranslation'
        db.delete_table('website_maincategorytranslation')

        # Deleting field 'Category.main_category'
        db.delete_column('website_category', 'main_category_id')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Vitrin.place'
        db.add_column('website_vitrin', 'place', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['places.Place'], null=True, blank=True), keep_default=False)

        # Adding field 'Vitrin.tops'
        db.add_column('website_vitrin', 'tops', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Vitrin.place'
        db.delete_column('website_vitrin', 'place_id')

        # Deleting field 'Vitrin.tops'
        db.delete_column('website_vitrin', 'tops')

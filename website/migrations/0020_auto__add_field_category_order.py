...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('website_category', 'order', self.gf('django.db.models.fields.SmallIntegerField')(default=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Category.order'
        db.delete_column('website_category', 'order')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 24, 15, 50, 19, 591974)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 24, 15, 50, 19, 591870)'}),

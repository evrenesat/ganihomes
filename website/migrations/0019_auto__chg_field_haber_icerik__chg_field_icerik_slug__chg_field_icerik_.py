...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('website_haber', 'icerik', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Icerik.slug'
        db.alter_column('website_icerik', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=255, null=True))

        # Changing field 'Icerik.metin'
        db.alter_column('website_icerik', 'metin', self.gf('django.db.models.fields.TextField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Haber.icerik'
        db.alter_column('website_haber', 'icerik', self.gf('tinymce.models.HTMLField')())

        # User chose to not deal with backwards NULL issues for 'Icerik.slug'
        raise RuntimeError("Cannot reverse this migration. 'Icerik.slug' and its values cannot be restored.")

        # Changing field 'Icerik.metin'
        db.alter_column('website_icerik', 'metin', self.gf('tinymce.models.HTMLField')(null=True))

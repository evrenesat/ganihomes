...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AnswerTranslation.active'
        db.add_column('website_answertranslation', 'active', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'QuestionTranslation.active'
        db.add_column('website_questiontranslation', 'active', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'CategoryTranslation.active'
        db.add_column('website_categorytranslation', 'active', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AnswerTranslation.active'
        db.delete_column('website_answertranslation', 'active')

        # Deleting field 'QuestionTranslation.active'
        db.delete_column('website_questiontranslation', 'active')

        # Deleting field 'CategoryTranslation.active'
        db.delete_column('website_categorytranslation', 'active')

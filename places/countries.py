...
OFFICIAL_COUNTRIES_DICT = dict(OFFICIAL_COUNTRIES)
COUNTRIES_DICT = dict(COUNTRIES)

LANGUAGES = (('aa',_(u'Afar')),
('ab',_(u'Abkhazian')),
('ae',_(u'Avestan')),
('af',_(u'Afrikaans')),
('ak',_(u'Akan')),
...
('km',_(u'Central Khmer; Cambodian')),
('kn',_(u'Kannada')),
('ko',_(u'Korean')),
('kr',_(u'Kanuri')),
('ks',_(u'Kashmiri')),
...
('ky',_(u'Kirghiz')),
('la',_(u'Latin')),
('lb',_(u'Letzeburgesch; Luxembourgish')),
('lg',_(u'Ganda')),
('li',_(u'Limburgish; Limburger; Limburgan')),
('ln',_(u'Lingala')),
('lo',_(u'Lao; Laotian')),
('lt',_(u'Lithuanian')),
('lu',_(u'Luba-Katanga')),
...
('sq',_(u'Albanian')),
('sr',_(u'Serbian')),
('ss',_(u'Swati; Siswati')),
('st',_(u'Sesotho; Sotho, Southern')),
('su',_(u'Sundanese')),
('sv',_(u'Swedish')),
('sw',_(u'Swahili')),
('ta',_(u'Tamil')),
...
('ve',_(u'Venda')),
('vi',_(u'Vietnamese')),
('vo',_(u'Volapük; Volapuk')),
('wa',_(u'Walloon')),
('wo',_(u'Wolof')),
('xh',_(u'Xhosa')),
('yi',_(u'Yiddish (formerly ji)')),
('yo',_(u'Yoruba')),
('za',_(u'Zhuang')),
('zh',_(u'Chinese')),
('zu',_(u'Zulu')) )

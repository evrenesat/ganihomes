...
('ky',_('Kirghiz')),
('la',_('Latin')),
('lb',_('Letzeburgesch; Luxembourgish')),
('lg',_('Ganda')),
('li',_('Limburgish; Limburger; Limburgan')),
('ln',_('Lingala')),
('lo',_('Lao; Laotian')),
('lt',_('Lithuanian')),
('lu',_('Luba-Katanga')),
...
('ve',_('Venda')),
('vi',_('Vietnamese')),
('vo',_('Volapük; Volapuk')),
('wa',_('Walloon')),
('wo',_('Wolof')),
('xh',_('Xhosa')),
('yi',_('Yiddish (formerly ji)')),
('yo',_('Yoruba')),
('za',_('Zhuang')),
('zh',_('Chinese')),
('zu',_('Zulu')) )

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Message.replyto'
        db.add_column('places_message', 'replyto', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['places.Message'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Message.replyto'
        db.delete_column('places_message', 'replyto_id')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 14, 16, 45, 26, 350000)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 14, 16, 45, 26, 349896)'}),

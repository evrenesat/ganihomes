...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Currency.factor'
        db.alter_column('places_currency', 'factor', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=4))


    def backwards(self, orm):
        
        # Changing field 'Currency.factor'
        db.alter_column('places_currency', 'factor', self.gf('django.db.models.fields.DecimalField')(max_digits=8, decimal_places=4))
    ...
    models = {
        ...
        'places.currency': {
            ...
            'factor': ('django.db.models.fields.DecimalField', [], {'default': '0.0', 'max_digits': '12', 'decimal_places': '4'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

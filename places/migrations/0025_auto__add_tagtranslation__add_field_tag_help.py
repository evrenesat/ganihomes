...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('places_tagtranslation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('tag', self.gf('django.db.models.fields.related.ForeignKey')(related_name='tags', to=orm['places.Tag'])),
            ('lang', self.gf('django.db.models.fields.CharField')(max_length=5)),
            ('translation', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('help', self.gf('django.db.models.fields.TextField')(default='')),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('places', ['TagTranslation'])

        # Adding field 'Tag.help'
        db.add_column('places_tag', 'help', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'TagTranslation'
        db.delete_table('places_tagtranslation')

        # Deleting field 'Tag.help'
        db.delete_column('places_tag', 'help')
    ...
    models = {
        ...
        'places.tag': {
            ...
            'help': ('django.db.models.fields.TextField', [], {'default': "''"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

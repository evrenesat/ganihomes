...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserReview.rating'
        db.add_column('places_userreview', 'rating', self.gf('django.db.models.fields.SmallIntegerField')(default=0), keep_default=False)

        # Changing field 'PlaceReview.place'
        db.alter_column('places_placereview', 'place_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['places.Place'], null=True))


    def backwards(self, orm):
        
        # Deleting field 'UserReview.rating'
        db.delete_column('places_userreview', 'rating')

        # User chose to not deal with backwards NULL issues for 'PlaceReview.place'
        raise RuntimeError("Cannot reverse this migration. 'PlaceReview.place' and its values cannot be restored.")
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 10, 11, 0, 24, 560026)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 10, 11, 0, 24, 559925)'}),
        ...
        'places.booking': {
            ...
            'payment_confirmation_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'payment_notification_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'payment_transfer_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
        ...
        'places.currency': {
            ...
            'modify_factor': ('django.db.models.fields.DecimalField', [], {'default': "'0'", 'max_digits': '12', 'decimal_places': '4'}),
        ...
        'places.message': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lang': ('django.db.models.fields.CharField', [], {'max_length': '2'}),
            'last_message_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 10, 10, 58, 41, 642601)'}),
        ...
        'places.place': {
            'Meta': {'ordering': "['-has_photo', '-overall_rating', 'timestamp']", 'object_name': 'Place'},
            'active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            ...
            'has_photo': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'i18_tags': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'places.placereview': {
            ...
            'active': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'booking': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['places.Booking']"}),
            'clean_rating': ('django.db.models.fields.SmallIntegerField', [], {'default': '0'}),
            'comfort_rating': ('django.db.models.fields.SmallIntegerField', [], {'default': '0'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lang': ('django.db.models.fields.CharField', [], {'max_length': '2'}),
        ...
        'places.profile': {
            ...
            'currency': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['places.Currency']", 'null': 'True', 'blank': 'True'}),
        ...
        'places.transaction': {
            ...
            'receiver_type': ('django.db.models.fields.SmallIntegerField', [], {}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PlaceReview.person'
        db.add_column('places_placereview', 'person', self.gf('django.db.models.fields.related.ForeignKey')(default=3, related_name='place_reviews_about_you', to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PlaceReview.person'
        db.delete_column('places_placereview', 'person_id')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 16, 7, 16, 48, 922712)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 16, 7, 16, 48, 922530)'}),
        ...
        'places.message': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_message_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 16, 7, 16, 13, 796139)'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Photo.place'
        db.alter_column('places_photo', 'place_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['places.Place'], null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Photo.place'
        raise RuntimeError("Cannot reverse this migration. 'Photo.place' and its values cannot be restored.")

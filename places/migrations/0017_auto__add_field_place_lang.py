...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Place.lang'
        db.add_column('places_place', 'lang', self.gf('django.db.models.fields.CharField')(default='tr-TR', max_length=5), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Place.lang'
        db.delete_column('places_place', 'lang')

...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Currency.factor'
        db.alter_column('places_currency', 'factor', self.gf('django.db.models.fields.DecimalField')(max_digits=8, decimal_places=2))
    ...
    models = {
        ...
        'places.currency': {
            ...
            'factor': ('django.db.models.fields.DecimalField', [], {'max_digits': '8', 'decimal_places': '4'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

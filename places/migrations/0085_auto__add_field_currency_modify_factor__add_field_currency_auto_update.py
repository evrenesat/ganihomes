...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Currency.modify_factor'
        db.add_column('places_currency', 'modify_factor', self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=12, decimal_places=4), keep_default=False)

        # Adding field 'Currency.auto_update'
        db.add_column('places_currency', 'auto_update', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Currency.modify_factor'
        db.delete_column('places_currency', 'modify_factor')

        # Deleting field 'Currency.auto_update'
        db.delete_column('places_currency', 'auto_update')
    ...
    models = {
        ...
        'places.message': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lang': ('django.db.models.fields.CharField', [], {'max_length': '2'}),
            'last_message_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 18, 0, 52, 21, 207327)'}),

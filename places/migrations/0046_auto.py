...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'GeoPlanet', fields ['name']
        db.create_index('places_geoplanet', ['name'])

        # Adding index on 'GeoPlanet', fields ['parent_id']
        db.create_index('places_geoplanet', ['parent_id'])


    def backwards(self, orm):
        
        # Removing index on 'GeoPlanet', fields ['parent_id']
        db.delete_index('places_geoplanet', ['parent_id'])

        # Removing index on 'GeoPlanet', fields ['name']
        db.delete_index('places_geoplanet', ['name'])
    ...
    models = {
        ...
        'places.geoplanet': {
            'Meta': {'ordering': "['priority', 'popularity']", 'object_name': 'GeoPlanet'},
            ...
            'parent_id': ('django.db.models.fields.IntegerField', [], {'db_index': 'True'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('places_profile', 'city', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Profile.city'
        raise RuntimeError("Cannot reverse this migration. 'Profile.city' and its values cannot be restored.")

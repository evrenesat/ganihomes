...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Booking.nguests'
        db.add_column('places_booking', 'nguests', self.gf('django.db.models.fields.SmallIntegerField')(default=1), keep_default=False)

        # Adding field 'Booking.currency'
        db.add_column('places_booking', 'currency', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['places.Currency']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Booking.nguests'
        db.delete_column('places_booking', 'nguests')

        # Deleting field 'Booking.currency'
        db.delete_column('places_booking', 'currency_id')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 15, 22, 52, 4, 550115)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 15, 22, 52, 4, 549964)'}),
        ...
        'places.message': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_message_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 15, 22, 51, 45, 91744)'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Currency.code_position'
        db.add_column('places_currency', 'code_position', self.gf('django.db.models.fields.SmallIntegerField')(default=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Currency.code_position'
        db.delete_column('places_currency', 'code_position')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Place.weekend_price'
        db.add_column('places_place', 'weekend_price', self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=6, decimal_places=2), keep_default=False)

        # Changing field 'SessionalPrice.weekend_price'
        db.alter_column('places_sessionalprice', 'weekend_price', self.gf('django.db.models.fields.DecimalField')(max_digits=8, decimal_places=2))


    def backwards(self, orm):
        
        # Deleting field 'Place.weekend_price'
        db.delete_column('places_place', 'weekend_price')

        # Changing field 'SessionalPrice.weekend_price'
        db.alter_column('places_sessionalprice', 'weekend_price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=2))
    ...
    models = {
        ...
        'places.sessionalprice': {
            ...
            'start': ('django.db.models.fields.DateField', [], {}),
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'weekend_price': ('django.db.models.fields.DecimalField', [], {'default': '0.0', 'max_digits': '8', 'decimal_places': '2', 'blank': 'True'})
        },
        'places.tag': {

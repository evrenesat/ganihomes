...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TagTranslation.lang'
        db.alter_column('places_tagtranslation', 'lang', self.gf('django.db.models.fields.CharField')(max_length=2))


    def backwards(self, orm):
        
        # Changing field 'TagTranslation.lang'
        db.alter_column('places_tagtranslation', 'lang', self.gf('django.db.models.fields.CharField')(max_length=5))

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Message.lass_message_time'
        db.delete_column('places_message', 'lass_message_time')

        # Adding field 'Message.last_message_time'
        db.add_column('places_message', 'last_message_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 1, 15, 1, 48, 36, 878946)), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Message.lass_message_time'
        raise RuntimeError("Cannot reverse this migration. 'Message.lass_message_time' and its values cannot be restored.")

        # Deleting field 'Message.last_message_time'
        db.delete_column('places_message', 'last_message_time')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 15, 1, 48, 36, 914681)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 15, 1, 48, 36, 914517)'}),
        ...
        'places.message': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_message_time': ('django.db.models.fields.DateTimeField', [], {}),
            'newreply': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),

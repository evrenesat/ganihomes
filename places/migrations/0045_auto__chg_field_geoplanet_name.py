...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'GeoPlanet.name'
        db.alter_column('places_geoplanet', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))


    def backwards(self, orm):
        
        # Changing field 'GeoPlanet.name'
        db.alter_column('places_geoplanet', 'name', self.gf('django.db.models.fields.CharField')(max_length=60))

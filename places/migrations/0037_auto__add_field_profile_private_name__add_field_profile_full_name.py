...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profile.private_name'
        db.add_column('places_profile', 'private_name', self.gf('django.db.models.fields.CharField')(max_length=60, null=True, blank=True), keep_default=False)

        # Adding field 'Profile.full_name'
        db.add_column('places_profile', 'full_name', self.gf('django.db.models.fields.CharField')(max_length=60, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Profile.private_name'
        db.delete_column('places_profile', 'private_name')

        # Deleting field 'Profile.full_name'
        db.delete_column('places_profile', 'full_name')

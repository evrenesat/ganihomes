...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ReservedDates.Place'
        db.delete_column('places_reserveddates', 'Place_id')

        # Adding field 'ReservedDates.place'
        db.add_column('places_reserveddates', 'place', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['places.Place']), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'ReservedDates.Place'
        raise RuntimeError("Cannot reverse this migration. 'ReservedDates.Place' and its values cannot be restored.")

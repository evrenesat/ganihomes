...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Place.translation_status'
        db.delete_column('places_place', 'translation_status')

        # Adding field 'Place.translated'
        db.add_column('places_place', 'translated', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Place.translation_status'
        db.add_column('places_place', 'translation_status', self.gf('django.db.models.fields.SmallIntegerField')(default=10), keep_default=False)

        # Deleting field 'Place.translated'
        db.delete_column('places_place', 'translated')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 27, 20, 0, 33, 459646)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 27, 20, 0, 33, 459540)'}),
        ...
        'places.message': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lang': ('django.db.models.fields.CharField', [], {'max_length': '2'}),
            'last_message_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 27, 20, 0, 33, 180315)'}),

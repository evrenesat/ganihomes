...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('places_place', 'active', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'Place.last_modified'
        db.add_column('places_place', 'last_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.date(2011, 10, 18), blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Place.last_modified'
        db.delete_column('places_place', 'last_modified')

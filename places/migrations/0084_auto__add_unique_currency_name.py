...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_unique('places_currency', ['name'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Currency', fields ['name']
        db.delete_unique('places_currency', ['name'])
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 17, 16, 50, 10, 21906)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 17, 16, 50, 10, 21800)'}),
        ...
        'places.message': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lang': ('django.db.models.fields.CharField', [], {'max_length': '2'}),
            'last_message_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 17, 16, 50, 9, 819706)'}),

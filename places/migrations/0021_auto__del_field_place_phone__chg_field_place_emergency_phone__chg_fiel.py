...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('places_place', 'phone')

        # Changing field 'Place.emergency_phone'
        db.alter_column('places_place', 'emergency_phone', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'Place.slug'
        db.alter_column('places_place', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50, null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Place.phone'
        raise RuntimeError("Cannot reverse this migration. 'Place.phone' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Place.emergency_phone'
        raise RuntimeError("Cannot reverse this migration. 'Place.emergency_phone' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Place.slug'
        raise RuntimeError("Cannot reverse this migration. 'Place.slug' and its values cannot be restored.")
    ...
    models = {
        ...
        'places.place': {
            ...
            'geocode': ('django.db.models.fields.CharField', [], {'max_length': '30', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lang': ('django.db.models.fields.CharField', [], {'max_length': '5'}),

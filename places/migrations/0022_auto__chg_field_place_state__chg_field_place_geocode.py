...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Place.state'
        db.alter_column('places_place', 'state', self.gf('django.db.models.fields.CharField')(max_length=40, null=True))

        # Changing field 'Place.geocode'
        db.alter_column('places_place', 'geocode', self.gf('django.db.models.fields.CharField')(max_length=40, null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Place.state'
        raise RuntimeError("Cannot reverse this migration. 'Place.state' and its values cannot be restored.")

        # Changing field 'Place.geocode'
        db.alter_column('places_place', 'geocode', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

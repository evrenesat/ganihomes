...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('places_friendship', (
            ...
            ('fr1', self.gf('django.db.models.fields.related.ForeignKey')(related_name='fr1', to=orm['places.Profile'])),
            ('fr2', self.gf('django.db.models.fields.related.ForeignKey')(related_name='fr2', to=orm['places.Profile'])),
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 19, 19, 24, 45, 74452)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 19, 19, 24, 45, 74349)'}),
        ...
        'places.message': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_message_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 19, 19, 24, 44, 852261)'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Place.reserved_dates'
        db.add_column('places_place', 'reserved_dates', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Place.reserved_dates'
        db.delete_column('places_place', 'reserved_dates')

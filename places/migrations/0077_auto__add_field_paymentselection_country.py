...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PaymentSelection.country'
        db.add_column('places_paymentselection', 'country', self.gf('django.db.models.fields.CharField')(default='TR', max_length=2), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PaymentSelection.country'
        db.delete_column('places_paymentselection', 'country')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 27, 5, 35, 30, 66839)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 27, 5, 35, 30, 66732)'}),
        ...
        'places.message': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_message_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 27, 5, 35, 8, 106647)'}),

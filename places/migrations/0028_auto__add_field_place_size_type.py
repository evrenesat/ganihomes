...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Place.size_type'
        db.add_column('places_place', 'size_type', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Place.size_type'
        db.delete_column('places_place', 'size_type')

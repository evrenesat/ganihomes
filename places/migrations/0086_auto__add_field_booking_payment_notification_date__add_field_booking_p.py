...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Booking.payment_notification_date'
        db.add_column('places_booking', 'payment_notification_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Booking.payment_confirmation_date'
        db.add_column('places_booking', 'payment_confirmation_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Booking.payment_transfer_date'
        db.add_column('places_booking', 'payment_transfer_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Booking.payment_notification_date'
        db.delete_column('places_booking', 'payment_notification_date')

        # Deleting field 'Booking.payment_confirmation_date'
        db.delete_column('places_booking', 'payment_confirmation_date')

        # Deleting field 'Booking.payment_transfer_date'
        db.delete_column('places_booking', 'payment_transfer_date')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 24, 17, 22, 51, 477673)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 24, 17, 22, 51, 477445)'}),
        ...
        'places.message': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lang': ('django.db.models.fields.CharField', [], {'max_length': '2'}),
            'last_message_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 24, 17, 22, 51, 46281)'}),

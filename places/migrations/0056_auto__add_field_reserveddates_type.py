...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ReservedDates.type'
        db.add_column('places_reserveddates', 'type', self.gf('django.db.models.fields.SmallIntegerField')(default=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ReservedDates.type'
        db.delete_column('places_reserveddates', 'type')

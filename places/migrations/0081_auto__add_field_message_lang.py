...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Message.lang'
        db.add_column('places_message', 'lang', self.gf('django.db.models.fields.CharField')(default='tr', max_length=2), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Message.lang'
        db.delete_column('places_message', 'lang')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 16, 22, 2, 0, 120452)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 16, 22, 2, 0, 120280)'}),
        ...
        'places.message': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lang': ('django.db.models.fields.CharField', [], {'max_length': '2'}),
            'last_message_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 16, 22, 1, 53, 125012)'}),

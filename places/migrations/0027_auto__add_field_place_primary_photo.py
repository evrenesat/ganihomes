...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Place.primary_photo'
        db.add_column('places_place', 'primary_photo', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Place.primary_photo'
        db.delete_column('places_place', 'primary_photo')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserReview.booking'
        db.add_column('places_userreview', 'booking', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['places.Booking']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserReview.booking'
        db.delete_column('places_userreview', 'booking_id')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 10, 14, 7, 32, 62395)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 10, 14, 7, 32, 62296)'}),
        ...
        'places.message': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lang': ('django.db.models.fields.CharField', [], {'max_length': '2'}),
            'last_message_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 10, 14, 7, 19, 722765)'}),

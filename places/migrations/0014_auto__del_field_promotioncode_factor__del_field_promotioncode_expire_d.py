...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'PromotionCode.factor'
        db.delete_column('places_promotioncode', 'factor')

        # Deleting field 'PromotionCode.expire_date'
        db.delete_column('places_promotioncode', 'expire_date')

        # Adding field 'PromotionCode.percentage'
        db.add_column('places_promotioncode', 'percentage', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=8, decimal_places=2), keep_default=False)

        # Adding field 'PromotionCode.expiry_date'
        db.add_column('places_promotioncode', 'expiry_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'PromotionCode.factor'
        raise RuntimeError("Cannot reverse this migration. 'PromotionCode.factor' and its values cannot be restored.")

        # Adding field 'PromotionCode.expire_date'
        db.add_column('places_promotioncode', 'expire_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)

        # Deleting field 'PromotionCode.percentage'
        db.delete_column('places_promotioncode', 'percentage')

        # Deleting field 'PromotionCode.expiry_date'
        db.delete_column('places_promotioncode', 'expiry_date')

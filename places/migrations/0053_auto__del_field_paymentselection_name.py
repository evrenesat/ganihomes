...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'PaymentSelection.name'
        db.delete_column('places_paymentselection', 'name')


    def backwards(self, orm):
        
        # Adding field 'PaymentSelection.name'
        db.add_column('places_paymentselection', 'name', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True), keep_default=False)

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('places_promotioncode', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('code', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('type', self.gf('django.db.models.fields.SmallIntegerField')()),
            ('puser', self.gf('django.db.models.fields.related.ForeignKey')(related_name='used_promotions', to=orm['auth.User'])),
            ('sender', self.gf('django.db.models.fields.related.ForeignKey')(related_name='related_promotions', to=orm['auth.User'])),
            ('factor', self.gf('django.db.models.fields.DecimalField')(max_digits=8, decimal_places=2)),
        ...
        db.send_create_signal('places', ['PromotionCode'])

        # Adding field 'Place.currency'
        db.add_column('places_place', 'currency', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['places.Currency']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'PromotionCode'
        db.delete_table('places_promotioncode')

        # Deleting field 'Place.currency'
        db.delete_column('places_place', 'currency_id')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Place.pets'
        db.delete_column('places_place', 'pets')

        # Changing field 'Place.size'
        db.alter_column('places_place', 'size', self.gf('django.db.models.fields.IntegerField')(null=True))


    def backwards(self, orm):
        
        # Adding field 'Place.pets'
        db.add_column('places_place', 'pets', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # User chose to not deal with backwards NULL issues for 'Place.size'
        raise RuntimeError("Cannot reverse this migration. 'Place.size' and its values cannot be restored.")

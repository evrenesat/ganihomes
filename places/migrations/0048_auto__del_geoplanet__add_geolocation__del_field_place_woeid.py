...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_table('places_geolocation')

        # User chose to not deal with backwards NULL issues for 'Place.woeid'
        raise RuntimeError("Cannot reverse this migration. 'Place.woeid' and its values cannot be restored.")

        # Removing M2M table for field placement on 'Place'
        db.delete_table('places_place_placement')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SessionalPrice.place'
        db.add_column('places_sessionalprice', 'place', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['places.Place']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SessionalPrice.place'
        db.delete_column('places_sessionalprice', 'place_id')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'GeoPlanet'
        db.create_table('places_geoplanet', (
            ('woeid', self.gf('django.db.models.fields.IntegerField')(primary_key=True)),
            ...
            ('alias', self.gf('django.db.models.fields.CharField')(default='', max_length=40)),
            ('popularity', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('priority', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('places', ['GeoPlanet'])

        # Adding field 'Place.woeid'
        db.add_column('places_place', 'woeid', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Place.neighborhood'
        db.add_column('places_place', 'neighborhood', self.gf('django.db.models.fields.CharField')(default='', max_length=40), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('places_place', 'neighborhood')
    ...
    models = {
        ...
        'places.geoplanet': {
            'Meta': {'ordering': "['woeid']", 'object_name': 'GeoPlanet'},
            'alias': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '40'}),
            ...
            'woeid': ('django.db.models.fields.IntegerField', [], {'primary_key': 'True'})
        },
        'places.message': {
        ...
        'places.place': {
            ...
            'neighborhood': ('django.db.models.fields.CharField', [], {'max_length': '40'}),

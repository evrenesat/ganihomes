...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Place.neighborhood'
        db.alter_column('places_place', 'neighborhood', self.gf('django.db.models.fields.CharField')(max_length=40, null=True))

        # Changing field 'Place.postcode'
        db.alter_column('places_place', 'postcode', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))

        # Changing field 'Place.district'
        db.alter_column('places_place', 'district', self.gf('django.db.models.fields.CharField')(max_length=40, null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Place.neighborhood'
        raise RuntimeError("Cannot reverse this migration. 'Place.neighborhood' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Place.postcode'
        raise RuntimeError("Cannot reverse this migration. 'Place.postcode' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Place.district'
        raise RuntimeError("Cannot reverse this migration. 'Place.district' and its values cannot be restored.")

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('places_profile', 'currency', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['places.Currency']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Profile.currency'
        db.delete_column('places_profile', 'currency_id')

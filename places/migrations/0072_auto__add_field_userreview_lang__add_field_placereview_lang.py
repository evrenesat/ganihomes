...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserReview.lang'
        db.add_column('places_userreview', 'lang', self.gf('django.db.models.fields.CharField')(default='tr', max_length=2), keep_default=False)

        # Adding field 'PlaceReview.lang'
        db.add_column('places_placereview', 'lang', self.gf('django.db.models.fields.CharField')(default='tr', max_length=2), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserReview.lang'
        db.delete_column('places_userreview', 'lang')

        # Deleting field 'PlaceReview.lang'
        db.delete_column('places_placereview', 'lang')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 16, 7, 33, 33, 240515)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 16, 7, 33, 33, 240416)'}),
        ...
        'places.message': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_message_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 16, 7, 33, 20, 62389)'}),

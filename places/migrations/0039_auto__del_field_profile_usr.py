...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Profile.usr'
        db.delete_column('places_profile', 'usr_id')


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Profile.usr'
        raise RuntimeError("Cannot reverse this migration. 'Profile.usr' and its values cannot be restored.")

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SessionalPrice.active'
        db.add_column('places_sessionalprice', 'active', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SessionalPrice.active'
        db.delete_column('places_sessionalprice', 'active')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('places_profile', 'user', self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='uuusr', unique=True, null=True, to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Profile.user'
        db.delete_column('places_profile', 'user_id')
    ...
    models = {
        ...
        'places.profile': {
            ...
            'user': ('django.db.models.fields.related.OneToOneField', [], {'blank': 'True', 'related_name': "'uuusr'", 'unique': 'True', 'null': 'True', 'to': "orm['auth.User']"}),
            'usr': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'uusr'", 'unique': 'True', 'to': "orm['auth.User']"})
        },

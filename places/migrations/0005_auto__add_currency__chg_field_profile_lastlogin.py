...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('places_currency', (
        ...
        db.send_create_signal('places', ['Currency'])

        # Changing field 'Profile.lastlogin'
        db.alter_column('places_profile', 'lastlogin', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))


    def backwards(self, orm):
        
        # Deleting model 'Currency'
        db.delete_table('places_currency')

        # Changing field 'Profile.lastlogin'
        db.alter_column('places_profile', 'lastlogin', self.gf('django.db.models.fields.DateTimeField')())

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'SessionalPrice.name'
        db.delete_column('places_sessionalprice', 'name')


    def backwards(self, orm):
        
        # Adding field 'SessionalPrice.name'
        db.add_column('places_sessionalprice', 'name', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True), keep_default=False)

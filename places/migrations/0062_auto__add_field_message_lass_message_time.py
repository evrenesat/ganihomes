...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Message.lass_message_time'
        db.add_column('places_message', 'lass_message_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.date(2012, 1, 15)), keep_default=False)
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 15, 1, 46, 18, 737257)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 15, 1, 46, 18, 737072)'}),
        ...
        'places.message': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lass_message_time': ('django.db.models.fields.DateTimeField', [], {}),

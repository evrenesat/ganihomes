...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Photo.type'
        db.add_column('places_photo', 'type', self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True), keep_default=False)

        # Deleting field 'Place.rating'
        db.delete_column('places_place', 'rating')

        # Adding field 'Place.overall_rating'
        db.add_column('places_place', 'overall_rating', self.gf('django.db.models.fields.SmallIntegerField')(default=0), keep_default=False)

        # Adding field 'Place.clean_rating'
        db.add_column('places_place', 'clean_rating', self.gf('django.db.models.fields.SmallIntegerField')(default=0), keep_default=False)

        # Adding field 'Place.comfort_rating'
        db.add_column('places_place', 'comfort_rating', self.gf('django.db.models.fields.SmallIntegerField')(default=0), keep_default=False)

        # Adding field 'Place.location_rating'
        db.add_column('places_place', 'location_rating', self.gf('django.db.models.fields.SmallIntegerField')(default=0), keep_default=False)

        # Adding field 'Place.value_money_rating'
        db.add_column('places_place', 'value_money_rating', self.gf('django.db.models.fields.SmallIntegerField')(default=0), keep_default=False)

        # Deleting field 'PlaceReview.rating'
        db.delete_column('places_placereview', 'rating')

        # Adding field 'PlaceReview.overall_rating'
        db.add_column('places_placereview', 'overall_rating', self.gf('django.db.models.fields.SmallIntegerField')(default=0), keep_default=False)

        # Adding field 'PlaceReview.clean_rating'
        db.add_column('places_placereview', 'clean_rating', self.gf('django.db.models.fields.SmallIntegerField')(default=0), keep_default=False)

        # Adding field 'PlaceReview.comfort_rating'
        db.add_column('places_placereview', 'comfort_rating', self.gf('django.db.models.fields.SmallIntegerField')(default=0), keep_default=False)

        # Adding field 'PlaceReview.location_rating'
        db.add_column('places_placereview', 'location_rating', self.gf('django.db.models.fields.SmallIntegerField')(default=0), keep_default=False)

        # Adding field 'PlaceReview.value_money_rating'
        db.add_column('places_placereview', 'value_money_rating', self.gf('django.db.models.fields.SmallIntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Photo.type'
        db.delete_column('places_photo', 'type')

        # Adding field 'Place.rating'
        db.add_column('places_place', 'rating', self.gf('django.db.models.fields.SmallIntegerField')(default=0), keep_default=False)

        # Deleting field 'Place.overall_rating'
        db.delete_column('places_place', 'overall_rating')

        # Deleting field 'Place.clean_rating'
        db.delete_column('places_place', 'clean_rating')

        # Deleting field 'Place.comfort_rating'
        db.delete_column('places_place', 'comfort_rating')

        # Deleting field 'Place.location_rating'
        db.delete_column('places_place', 'location_rating')

        # Deleting field 'Place.value_money_rating'
        db.delete_column('places_place', 'value_money_rating')

        # Adding field 'PlaceReview.rating'
        db.add_column('places_placereview', 'rating', self.gf('django.db.models.fields.SmallIntegerField')(default=0), keep_default=False)

        # Deleting field 'PlaceReview.overall_rating'
        db.delete_column('places_placereview', 'overall_rating')

        # Deleting field 'PlaceReview.clean_rating'
        db.delete_column('places_placereview', 'clean_rating')

        # Deleting field 'PlaceReview.comfort_rating'
        db.delete_column('places_placereview', 'comfort_rating')

        # Deleting field 'PlaceReview.location_rating'
        db.delete_column('places_placereview', 'location_rating')

        # Deleting field 'PlaceReview.value_money_rating'
        db.delete_column('places_placereview', 'value_money_rating')

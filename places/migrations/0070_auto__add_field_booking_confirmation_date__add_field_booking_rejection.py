...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Booking.confirmation_date'
        db.add_column('places_booking', 'confirmation_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Booking.rejection_date'
        db.add_column('places_booking', 'rejection_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Booking.guest_ok_date'
        db.add_column('places_booking', 'guest_ok_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Booking.confirmation_date'
        db.delete_column('places_booking', 'confirmation_date')

        # Deleting field 'Booking.rejection_date'
        db.delete_column('places_booking', 'rejection_date')

        # Deleting field 'Booking.guest_ok_date'
        db.delete_column('places_booking', 'guest_ok_date')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 16, 6, 34, 34, 891850)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 16, 6, 34, 34, 891747)'}),
        ...
        'places.message': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_message_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 16, 6, 34, 34, 686792)'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Message.hasnewrepy'
        db.delete_column('places_message', 'hasnewrepy')

        # Adding field 'Message.newreply'
        db.add_column('places_message', 'newreply', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Message.hasnewrepy'
        db.add_column('places_message', 'hasnewrepy', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Deleting field 'Message.newreply'
        db.delete_column('places_message', 'newreply')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 14, 19, 35, 56, 943312)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 14, 19, 35, 56, 943139)'}),

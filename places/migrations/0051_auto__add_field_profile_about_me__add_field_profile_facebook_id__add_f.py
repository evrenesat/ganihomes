...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('places_profile', 'about_me', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'Profile.facebook_id'
        db.add_column('places_profile', 'facebook_id', self.gf('django.db.models.fields.BigIntegerField')(unique=True, null=True, blank=True), keep_default=False)

        # Adding field 'Profile.access_token'
        db.add_column('places_profile', 'access_token', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'Profile.facebook_name'
        db.add_column('places_profile', 'facebook_name', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)

        # Adding field 'Profile.facebook_profile_url'
        db.add_column('places_profile', 'facebook_profile_url', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'Profile.website_url'
        db.add_column('places_profile', 'website_url', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'Profile.blog_url'
        db.add_column('places_profile', 'blog_url', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'Profile.image'
        db.add_column('places_profile', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'Profile.date_of_birth'
        db.add_column('places_profile', 'date_of_birth', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)

        # Adding field 'Profile.raw_data'
        db.add_column('places_profile', 'raw_data', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Profile.about_me'
        db.delete_column('places_profile', 'about_me')

        # Deleting field 'Profile.facebook_id'
        db.delete_column('places_profile', 'facebook_id')

        # Deleting field 'Profile.access_token'
        db.delete_column('places_profile', 'access_token')

        # Deleting field 'Profile.facebook_name'
        db.delete_column('places_profile', 'facebook_name')

        # Deleting field 'Profile.facebook_profile_url'
        db.delete_column('places_profile', 'facebook_profile_url')

        # Deleting field 'Profile.website_url'
        db.delete_column('places_profile', 'website_url')

        # Deleting field 'Profile.blog_url'
        db.delete_column('places_profile', 'blog_url')

        # Deleting field 'Profile.image'
        db.delete_column('places_profile', 'image')

        # Deleting field 'Profile.date_of_birth'
        db.delete_column('places_profile', 'date_of_birth')

        # Deleting field 'Profile.raw_data'
        db.delete_column('places_profile', 'raw_data')

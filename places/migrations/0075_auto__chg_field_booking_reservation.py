...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Booking.reservation'
        db.alter_column('places_booking', 'reservation_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['places.ReservedDates'], null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Booking.reservation'
        raise RuntimeError("Cannot reverse this migration. 'Booking.reservation' and its values cannot be restored.")
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 26, 20, 37, 34, 135679)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 26, 20, 37, 34, 135499)'}),
        ...
        'places.message': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_message_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 26, 20, 37, 32, 338453)'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Place.geocode'
        db.delete_column('places_place', 'geocode')

        # Adding field 'Place.lat'
        db.add_column('places_place', 'lat', self.gf('django.db.models.fields.FloatField')(default=0.0), keep_default=False)

        # Adding field 'Place.lon'
        db.add_column('places_place', 'lon', self.gf('django.db.models.fields.FloatField')(default=0.0), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Place.geocode'
        db.add_column('places_place', 'geocode', self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True), keep_default=False)

        # Deleting field 'Place.lat'
        db.delete_column('places_place', 'lat')

        # Deleting field 'Place.lon'
        db.delete_column('places_place', 'lon')

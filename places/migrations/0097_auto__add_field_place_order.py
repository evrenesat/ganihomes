...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Place.order'
        db.add_column('places_place', 'order',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Place.order'
        db.delete_column('places_place', 'order')
    ...
    models = {
        ...
        'places.message': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lang': ('django.db.models.fields.CharField', [], {'max_length': '2'}),
            'last_message_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 23, 0, 0)'}),
        ...
        'places.place': {
            'Meta': {'ordering': "['-has_photo', '-overall_rating', '-order']", 'object_name': 'Place'},
            'active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
        ...
        'places.placereview': {
            ...
            'clean_rating': ('django.db.models.fields.SmallIntegerField', [], {}),
            'comfort_rating': ('django.db.models.fields.SmallIntegerField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lang': ('django.db.models.fields.CharField', [], {'max_length': '2'}),
            'location_rating': ('django.db.models.fields.SmallIntegerField', [], {}),
            'overall_rating': ('django.db.models.fields.SmallIntegerField', [], {}),
            'person': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'place_reviews_about_you'", 'to': "orm['auth.User']"}),
            'place': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['places.Place']", 'null': 'True', 'blank': 'True'}),
            'status': ('django.db.models.fields.SmallIntegerField', [], {'default': '1'}),
            'text': ('django.db.models.fields.TextField', [], {}),
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'value_money_rating': ('django.db.models.fields.SmallIntegerField', [], {}),

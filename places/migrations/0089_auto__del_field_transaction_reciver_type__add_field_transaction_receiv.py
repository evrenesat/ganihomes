...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Transaction.reciver_type'
        db.delete_column('places_transaction', 'reciver_type')

        # Adding field 'Transaction.receiver_type'
        db.add_column('places_transaction', 'receiver_type', self.gf('django.db.models.fields.SmallIntegerField')(default=40), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Transaction.reciver_type'
        raise RuntimeError("Cannot reverse this migration. 'Transaction.reciver_type' and its values cannot be restored.")

        # Deleting field 'Transaction.receiver_type'
        db.delete_column('places_transaction', 'receiver_type')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 13, 12, 30, 25, 680828)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 13, 12, 30, 25, 680647)'}),
        ...
        'places.message': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lang': ('django.db.models.fields.CharField', [], {'max_length': '2'}),
            'last_message_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 13, 12, 30, 7, 440115)'}),

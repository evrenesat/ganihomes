...
#    (r'banner/altsayfa.xml$', 'bannerxml',{'tip':2} , 'bannerxml'),
    ...
    (r'^add_place_ajax/(?P<id>\d+)$', 'addPlace', {'template_name':"add_place_wizard.html"}, 'edit_place_ajax'),
    (r'^add_place_ajax/$', 'addPlace', {'template_name':"add_place_wizard.html"}, 'add_place_ajax'),
